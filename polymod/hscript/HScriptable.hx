...
class HScriptParams
{
  ...
  public function mergePathName(newValue:String, ?newDynValue:String = null):HScriptParams
  {
    ...
    {
      if (pathNameDynId == null && newValue != null) pathName = newValue;
    }
    return this;
  }
